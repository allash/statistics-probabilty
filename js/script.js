...
function sum(data) {
  var list = data.split(' ').map(e => { return parseInt(e); });
...
var patientReadingLevel = '6 4 4 3 3 2 6 5 4 7 2 17';
var pamphletReadingLevel = '3 3 8 4 1 1 4 2 1 2 1';
var stemplot = stemplot(pamphletReadingLevel);

document.write('<br />');
document.write('median: ' + median(pamphletReadingLevel));
document.write('sum: ' + sum(pamphletReadingLevel));
